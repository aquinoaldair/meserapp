...
@section('breadcrumb-item')
    <li class="breadcrumb-item active">{{ __(\App\Models\Image::NAME)}}</li>
@endsection
...
@section('body')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('image.create') }}" class="btn btn-primary text-white" type="button">
                            ...
                            <table class="display" id="datatable">
                                ...
                                @foreach($data as $item)
                                    <tr data-id="{{ $item->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('image.edit', $item) }}" class="btn btn-pill btn-info text-white"  data-toggle="tooltip" title="" data-original-title="{{ __("Editar") }}">
    ...
    <form action="{{route('image.destroy', ':data-id')}}" id="form-destroy">@csrf</form>
