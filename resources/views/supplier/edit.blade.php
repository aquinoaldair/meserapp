    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-xl-4">
                <div class="card">
                    <form action="{{ route('supplier.update', $supplier) }}"  method="post" class="theme-form" autocomplete="off">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="name" class="form-control" value="{{ $supplier->name }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="address" class="form-control" value="{{ $supplier->address }}">
                                @error('address')
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="phone_number" class="form-control" value="{{ $supplier->phone_number }}">
                                @error('phone_number')
