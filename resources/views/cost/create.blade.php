    ...
    <div class="container-fluid" id="app">
        <div class="row">
            <div class="col-sm-12 col-xl-4">
                <div class="card">
                    <form action="{{ route('cost.store') }}" enctype="multipart/form-data" method="post" class="theme-form" autocomplete="off">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input required type="number" value="{{ old('cost') }}" name="cost" step='0.01' value='0.00' class="form-control">
                                        @error('cost')
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="bill"  value="{{ old('bill') }}" class="form-control">
                                        @error('bill')
