    ...
    <div class="container-fluid" id="app">
        <div class="row">
            <div class="col-sm-12 col-xl-4">
                <div class="card">
                    <form action="{{ route('waiter.update', $waiter) }}" method="post" class="theme-form" autocomplete="off">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="form-group">
                                <label>{{ __('Nombre') }}</label>
                                <input required type="text" name="name" value="{{ old('name') ?? $waiter->user->name }}" class="form-control">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="email" value="{{ old('email') ?? $waiter->user->email }}" class="form-control">
                                @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" value="{{ old('address') ?? $waiter->address }}" class="form-control">
                                @error('address')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="{{ old('phone') ?? $waiter->phone }}" class="form-control">
                                @error('phone')
